...
export function normalizeSettingValueForStorage(key, value) {
    ...
    if (key === 'layout_card_style' && !['style1', 'style2', 'style3', 'style4', 'style5'].includes(text)) {
        return { ok: false, message: 'Invalid layout_card_style' };
    }

    if (key === 'mobile_layout_card_style' && !['style1', 'style2', 'style3', 'style4', 'style5'].includes(text)) {
